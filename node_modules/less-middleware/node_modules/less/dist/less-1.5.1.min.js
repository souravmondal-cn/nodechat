...
!function(a, b) {
    ...
    function r(b, c, d, e, f) {
        ...
        if (c ? (i.entryPath = c.entryPath, i.rootpath = c.rootpath, i.rootFilename = c.rootFilename, i.relativeUrls = c.relativeUrls) : (i.entryPath = g.path, i.rootpath = w.rootpath || g.path, i.rootFilename = h, i.relativeUrls = e.relativeUrls), i.relativeUrls && (i.rootpath = e.rootpath ? n(e.rootpath + o(g.path, i.entryPath)).path : g.path), e.useFileCache && E[h])
            try {
                var j = E[h];
    ...
    function s(a, b, c, d, e) {
        ...
        f.mime = a.type, (e || F) && (f.useFileCache = !0), r(a.href, null, function(e, h, i, j, k) {
            if (k) {
                ...
                if (!c && n && k.lastModified && new Date(k.lastModified).valueOf() === new Date(n).valueOf())
    ...
    w === b && (w = exports, x = c("./tree"), w.mode = "node"), w.Parser = function(a) {
        ...
        function i(a) {
            for (var b = r, c = s, d = r + y[s].length, e = r += a; d > r && g(q.charAt(r)); )
                r++;
        ...
        return p.prototype = new Error, p.prototype.constructor = p, this.env = a = a || {}, this.optimization = "optimization"in this.env ? this.env.optimization : 1, A = {imports: C, parse: function(b, d) {
                ...
                if (r = s = z = v = 0, q = b.replace(/\r\n/g, "\n"), q = q.replace(/^\uFEFF/, ""), A.imports.contents[a.currentFileInfo.filename] = q, y = function(b) {
                    for (var c, d, e, f, g = 0, h = /(?:@\{[\w-]+\}|[^"'`\{\}\/\(\)\\])+/g, j = /\/\*(?:[^*]|\*+[^\/*])*\*+\/|\/\/.*/g, k = /"((?:[^"\\\r\n]|\\.)*)"|'((?:[^'\\\r\n]|\\.)*)'|`((?:[^`]|\\.)*)`/g, l = 0, m = b[0], n = 0; n < q.length; )
                        if (h.lastIndex = n, (c = h.exec(q)) && c.index === n && (n += c[0].length, m.push(c[0])), e = q.charAt(n), j.lastIndex = k.lastIndex = n, (c = k.exec(q)) && c.index === n)
                            n += c[0].length, m.push(c[0]);
                        else if (d || "/" !== e || (f = q.charAt(n + 1), "/" !== f && "*" !== f || !(c = j.exec(q)) || c.index !== n)) {
                            switch (e) {
                                case"{":
                                    if (!d) {
                                        l++, m.push(e);
                ...
                return a.processImports === !1 ? l() : (new x.importVisitor(this.imports, l).run(e), void 0)
                    ...
                    var b;
                    if ("/" === q.charAt(r))
                        return"/" === q.charAt(r + 1) ? new x.Comment(h(/^\/\/.*/), !0, r, a.currentFileInfo) : (b = h(/^\/\*(?:[^*]|\*+[^\/*])*\*+\/\n?/)) ? new x.Comment(b, !1, r, a.currentFileInfo) : void 0
                }, comments: function() {
                    for (var a, b = []; a = h(this.comment); )
                        b.push(a);
                    return b
                        ...
                        if (b = /^([\w-]+|%|progid:[\w\.]+)\(/.exec(y[s])) {
                            if (b = b[1], c = b.toLowerCase(), "url" === c)
                                return null;
                            if (r += b.length, "alpha" === c && (e = h(this.alpha), "undefined" != typeof e))
                                return e;
                        ...
                        if ("u" === q.charAt(r) && h(/^url\(/))
                            return b = h(this.entities.quoted) || h(this.entities.variable) || h(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || "", j(")"), new x.URL(null != b.value || b instanceof x.Variable ? b : new x.Anonymous(b), a.currentFileInfo)
                    }, variable: function() {
                        var b, c = r;
                        ...
                        if (!(b > 57 || 43 > b || 47 === b || 44 == b))
                            return(a = h(/^([+-]?\d*\.?\d+)(%|[a-z]+)?/)) ? new x.Dimension(a[1], a[2]) : void 0
                    ...
                    return this.extend(!0)
                        ...
                        if ("." === k || "#" === k) {
                            for (d(); b = h(/^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/); )
                                g.push(new x.Element(c, b, r, a.currentFileInfo)), c = h(">");
                        ...
                        for (var b, c, d, e, f, g, i = [], l = [], m = [], n = {args: null, variadic: !1}; ; ) {
                            ...
                            var o = null;
                            if (a ? 1 == g.value.length && (o = g.value[0]) : o = g, o && o instanceof x.Variable)
                                if (h(":"))
                                    i.length > 0 && (b && k("Cannot mix ; and , as delimiter types"), c = !0), f = j(this.expression), e = d = o.name;
                                else {
                                    if (!a && h(/^\.{3}/)) {
                        ...
                        if (!("." !== q.charAt(r) && "#" !== q.charAt(r) || l(/^[^{]*\}/)) && (d(), b = h(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/))) {
                            ...
                            if (g = k.args, i = k.variadic, h(")") || (v = r, e()), h(this.comments), h(/^when/) && (f = j(this.conditions, "expected condition")), c = h(this.block))
                    ...
                    var a;
                    if (h(/^\(opacity=/i))
                        return(a = h(/^\d+/) || h(this.entities.variable)) ? (j(")"), new x.Alpha(a)) : void 0
                }, element: function() {
                    var b, c, d;
                    ...
                    var a, b, c;
                    if (h("["))
                        return(a = h(this.entities.variableCurly)) || (a = j(/^(?:[_A-Za-z0-9-\*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)), (c = h(/^[|~*$^]?=/)) && (b = h(this.entities.quoted) || h(/^[0-9]+%/) || h(/^[\w-]+/) || h(this.entities.variableCurly)), j("]"), new x.Attribute(a, c, b)
                }, block: function() {
                    var a;
                    return h("{") && (a = h(this.primary)) && h("}") ? a : void 0
                }, ruleset: function() {
                    var b, c, f, g = [];
                    for (d(), a.dumpLineNumbers && (f = o(r, q, a)); (b = h(this.lessSelector)) && (g.push(b), h(this.comments), h(",")); )
                        b.condition && k("Guards are only currently allowed on a single selector."), h(this.comments);
                    ...
                    if (d(), "." !== i && "#" !== i && "&" !== i && (c = h(this.variable) || h(this.ruleProperty))) {
                        if (f = b || !a.compress && "@" !== c.charAt(0) ? h(this.anonymousValue) || h(this.value) : h(this.value) || h(this.anonymousValue), g = h(this.important), "+" === c[c.length - 1] && (j = !0, c = c.substr(0, c.length - 1)), f && h(this.end))
                    ...
                    do
                        if (b = h(this.entities.keyword) || h(this.entities.variable))
                            ...
                            if (c = h(this.property), b = h(this.value), !h(")"))
                                return null;
                            if (c && b)
                                d.push(new x.Paren(new x.Rule(c, b, null, null, r, a.currentFileInfo, !0)));
                            else {
                                if (!b)
                                    return null;
                    ...
                    do
                        if (a = h(this.mediaFeature)) {
                            if (b.push(a), !h(","))
                                break
                        } else if ((a = h(this.entities.variable)) && (b.push(a), !h(",")))
                            break;
                    while (a);
                    ...
                    var b, c, f, g, i, j, k, l;
                    if ("@" === q.charAt(r)) {
                        if (c = h(this["import"]) || h(this.media))
                            return c;
                        if (d(), b = h(/^@[a-z-]+/)) {
                    ...
                    var a, b, c, d, e;
                    if (a = h(this.operand)) {
                        for (e = g(q.charAt(r - 1)); !l(/^\/[*\/]/) && (c = h("/") || h("*")) && (b = h(this.operand)); )
                            a.parensInOp = !0, b.parensInOp = !0, d = new x.Operation(c, [d || a, b], e), e = g(q.charAt(r - 1));
                        return d || a
                    }
                }, addition: function() {
                    var a, b, c, d, e;
                    if (a = h(this.multiplication)) {
                        for (e = g(q.charAt(r - 1)); (c = h(/^[-+]\s+/) || !e && (h("+") || h("-"))) && (b = h(this.multiplication)); )
                            a.parensInOp = !0, b.parensInOp = !0, d = new x.Operation(c, [d || a, b], e), e = g(q.charAt(r - 1));
                        return d || a
                    }
                }, conditions: function() {
                    ...
                    if (a = h(this.condition)) {
                        for (; l(/^,\s*(not\s*)?\(/) && h(",") && (b = h(this.condition)); )
                    ...
                    for (var a, b, c = []; a = h(this.addition) || h(this.entity); )
                        c.push(a), !l(/^\/[\/*]/) && (b = h("/")) && c.push(new x.Anonymous(b));
        ...
        d.functions = {rgb: function(a, b, c) {
                ...
                if (c instanceof d.Dimension)
                    return new d.Dimension(a(parseFloat(c.value)), null == b ? c.unit : b);
                if ("number" == typeof c)
                    return a(c);
        ...
        for (var i = [{name: "ceil"}, {name: "floor"}, {name: "sqrt"}, {name: "abs"}, {name: "tan", unit: ""}, {name: "sin", unit: ""}, {name: "cos", unit: ""}, {name: "atan", unit: "rad"}, {name: "asin", unit: "rad"}, {name: "acos", unit: "rad"}], j = function(a, b) {
            return function(c) {
    ...
    if (w.logLevel = "undefined" != typeof w.logLevel ? w.logLevel : z.info, w.async = w.async || !1, w.fileAsync = w.fileAsync || !1, w.poll = w.poll || (y ? 1e3 : 1500), w.functions)
        for (var A in w.functions)
            w.tree.functions[A] = w.functions[A];
    ...
    for (var I = 0; I < H.length; I++)
        ("stylesheet/less" === H[I].rel || H[I].rel.match(/stylesheet/) && H[I].type.match(C)) && w.sheets.push(H[I]);
