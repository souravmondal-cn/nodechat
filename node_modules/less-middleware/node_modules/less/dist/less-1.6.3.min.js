    ...
    v === b && (v = exports, w = c("./tree"), v.mode = "node"), v.Parser = function(a) {
        ...
        return t.prototype = new Error, t.prototype.constructor = t, this.env = a = a || {}, this.optimization = "optimization"in this.env ? this.env.optimization : 1, F = {imports: I, parse: function(d, e, f) {
                ...
                return a.processImports === !1 ? p() : (new w.importVisitor(this.imports, p).run(g), void 0)
                    ...
                    if (d(), "." !== h && "#" !== h && "&" !== h && (c = this.variable() || this.ruleProperty())) {
                        if (f = !b && (a.compress || c.charAt && "@" === c.charAt(0)) ? this.value() || this.anonymousValue() : this.anonymousValue() || this.value(), g = this.important(), i = c.pop && "+" === c.pop().value, f && this.end())
                    ...
                    for (b(/^(\*?)/); b(/^((?:[\w-]+)|(?:@\{[\w-]+\}))/); )
                        ;
                    if (f.length > 1 && b(/^\s*(\+?)\s*:/)) {
                        for (k(h), "" === f[0] && (f.shift(), g.shift()), d = 0; d < f.length; d++)
                            c = f[d], f[d] = "@" !== c.charAt(0) ? new w.Keyword(c) : new w.Variable("@" + c.slice(2, -1), g[d], a.currentFileInfo);
                        return f
                    }
                }}}
        ...
        a.Ruleset = function(a, b, c) {
            this.selectors = a, this.rules = b, this._lookups = {}, this.strictImports = c
                ...
                for (e = 0; o > e; e++)
                    n[e]instanceof a.mixin.Definition && (n[e].frames = l.slice(0));
                var p = b.mediaBlocks && b.mediaBlocks.length || 0;
                for (e = 0; o > e; e++)
                    n[e]instanceof a.mixin.Call && (j = n[e].eval(b).filter(function(b) {
                ...
                for (e = 0; e < n.length; e++)
                    if (h = n[e], !(h instanceof a.mixin.Definition) && (n[e] = h = h.eval ? h.eval(b) : h, h instanceof a.Ruleset && h.selectors && 1 === h.selectors.length && h.selectors[0].isJustParentSelector())) {
                        if (n.splice(e--, 1), !h.selectors[0].evaldCondition)
                            continue;
                        for (var q = 0; q < h.rules.length; q++)
                            i = h.rules[q], i instanceof a.Rule && i.variable || n.splice(++e, 0, i)
                    }
                if (l.shift(), m.shift(), b.mediaBlocks)
                    for (e = p; e < b.mediaBlocks.length; e++)
